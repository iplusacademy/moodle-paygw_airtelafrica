...
/**
 * Airtel Africa repository module to encapsulate all of the AJAX requests that can be sent for Airtel Africa.
 *
...
/**
 * Return the Airtel Africa configuration.
 *
...
export const getConfigForJs = (component, paymentArea, itemId) => {
    const request = {
        methodname: 'paygw_airtelafrica_get_config_for_js',
        args: {
            component,
