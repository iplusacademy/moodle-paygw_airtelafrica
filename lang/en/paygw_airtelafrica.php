...
$string['clientidsb'] = 'Client sandbox ID';
$string['clientidsb_help'] = 'The client sandbox ID that Airtel Africa generated for your application.';
...
$string['ESB000001'] = 'Something went wrong.';
$string['ESB000004'] = 'An error occurred while initiating the payment.';
$string['ESB000008'] = 'Field validation.';
$string['ESB000011'] = 'Transaction failed.';
$string['ESB000010'] = 'Your transaction has been successfully processed.';
$string['ESB000014'] = 'An error occurred while fetching the transaction status.';
$string['ESB000033'] = 'Invalid MSISDN Length. MSISDN Length should be ';
$string['ESB000034'] = 'Invalid Country Name.';
$string['ESB000035'] = 'Invalid Currency Code.';
$string['ESB000036'] = 'Invalid MSISDN Length. MSISDN Length should be ? and should start with 0.';
$string['ESB000039'] = 'Vendor is not configured to do transaction in the country.';
$string['ESB000041'] = 'External transaction ID already exists.';
$string['ESB000045'] = 'No transaction found with provided transaction Id.';
